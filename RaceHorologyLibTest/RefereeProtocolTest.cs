  ...
  public class RefereeProtocolTest
  {
    ...
    public void RefereeProtocol_Empty()
    {
      ...
      TestDataGenerator tg = new TestDataGenerator(workingDir);
      {
        ...
        Assert.IsTrue(TestUtilities.GenerateAndCompareAgainstPdf(TestContext, report, @"RefereeProtocol_Empty.pdf", 5));
      }
    }
    ...
    public void RefereeProtocol_IntegrationTest()
    {
      ...
      AppDataModel model = new AppDataModel(db);
      {
        ...
        Assert.IsTrue(TestUtilities.GenerateAndCompareAgainstPdf(TestContext, report, @"1554MSBS - Schiedsrichterprotokoll 1. Durchgang.pdf", 5));
      }
    }
